...
class _ArticleFollowUpChatState extends ConsumerState<_ArticleFollowUpChat>
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: [
            ...
            _buildHeader(colors),
            Expanded(
              // First paint of a persisted conversation: skeletons shaped like
              // the chat bubbles that are about to land, not a blank spinner.
              child: _loading
                  ? const Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // `_extendedPhases` copy, still advanced by this sheet's own
                  // 5-second timer.
                  NexusLoader(
  ...
  Widget _modelChip(AppColors colors, String model) {
    ...
    final color =
        isLite ? colors.modeLite : colors.modeDeep;
  ...
  Widget _buildProviderToggle(AppColors colors) {
    const geminiColor = AppColors.geminiBlue;
    const xgrokColor = AppColors.xgrokRed;
    final still = reducedMotion(context);
    ...
    return Semantics(
      ...
      enabled: !_sending,
      toggled: _useXGrok,
      label: _useXGrok ? 'Provider: xGrok' : 'Provider: Gemini',
      child: GestureDetector(
        onTap: _sending
            ? null
            : () {
